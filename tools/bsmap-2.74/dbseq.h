...
#define PREFETCH_CAL_INDEX 20
#define PREFETCH_CRT_INDEX 20
...
public:
	...
	inline bit32_t s_MakeSeed_1(bit32_t *_m, int _a);
    ...
    gHit int2hit(gHit h, bit32_t c, int gap_size, bit32_t gap_pos);
